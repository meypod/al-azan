...
export const CalculationMethods: Record<string, CalculationMethodEntry> = {
  ...
  MoonsightingCommittee: {
    label: 'Moonsighting Committee' as const,
  ...
  NorthAmerica: {
    label: 'Referred to as the ISNA method' as const,
